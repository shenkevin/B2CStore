...
public class ShoppingCarLvAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		vh.ck_category_name.setText(item.ClassName);
		...
		vh.iv_item_pic.setOnClickListener(new OnClickListener() {
			@Override
...
//				L.d("VVV", "updating "+item.toString()+" \nto "+cartItem.toString());
	...
	class ViewHolder {
		...
		@Bind(R.id.ck_radiobutton_category_name) CheckBox ck_category_name;
		@Bind(R.id.iv_image) public ImageView iv_item_pic;
		@Bind(R.id.iv_icon_del) public ImageView iv_delete_icon;
		@Bind(R.id.btn_commodity_plus) public ImageView iv_plus;
		@Bind(R.id.btn_commodity_minus) public ImageView iv_sous;
		@Bind(R.id.tv_item_name) public TextView  tv_title;
		@Bind(R.id.tv_item_price) public TextView tv_unit_price;
		@Bind(R.id.tv_item_count_static) public TextView tv_item_count_static;
		@Bind(R.id.btn_commodity_number_display) public CustomListeningTextview tv_item_count_dynamic;
		@Bind(R.id.tv_product_commodities) public TextView tv_product_commodities;
