...
public class GoodsManagementActivity extends FragmentActivity
{
	...
	// views
	@Bind(R.id.viewpager_goodsmanagement) ViewPager mViewpager;
	@Bind(R.id.tabs)
	SlidingTabLayout tabs;
	@Bind(R.id.title_name) TextView tv_middle;
	@Bind(R.id.title_back) ImageView iv_title_back;
	@Bind(R.id.the_title_layout) RelativeLayout titleLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titleLayout.setBackgroundColor(getResources().getColor(R.color.status_bar_color));
	...
	private void initValuez(Intent launcher) {
		...
		tv_middle.setText(getString(R.string.goods_managment)); tv_middle.setVisibility(View.VISIBLE);
	}
