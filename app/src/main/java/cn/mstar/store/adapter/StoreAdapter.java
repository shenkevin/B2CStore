...
public class StoreAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(storeInfo.getStoreURL()!=null && !"".equals(storeInfo.getStoreURL()))
				ImageLoader.getInstance().displayImage(storeInfo.getStoreURL(), viewHolder.storeIV, ImageLoadOptions.getOptions());
		viewHolder.timeTV.setText(storeInfo.getTime());
		viewHolder.distenceTV.setText(storeInfo.getDistance());
		viewHolder.PhoneTV.setText(storeInfo.getPhone());
